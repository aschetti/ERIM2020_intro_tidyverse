...
These colors are terrible... let's use a better-looking color palette. The package ```viridis``` uses colors that are easier to distinguish for people with colorblindness.
