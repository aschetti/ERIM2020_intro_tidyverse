...
set.seed(20200304) # set seed of random number generator, to ensure reproducibility
...
Another good (and low-effort `r emo::ji("smile")`) option is to use the function ```sessonInfo```, which lists important information related to your operating system and libraries as well as R and package versions.
...
[^8]: If you prefer **not** to bootstrap your effect sizes, you can use the ```MBESS``` package (a useful tutorial can be found [here](http://osc.centerforopenscience.org/2014/03/06/confidence%20intervals/)).
